...
excel_sheets("~/Desktop/GitHub/EEMB 144L/144l_students_2021/Input_Data/week4/144L_2021_BactAbund.xlsx")
```
...
metadata <- read_excel("~/Desktop/GitHub/EEMB 144L/144l_students_2021/Input_Data/week4/144L_2021_BactAbund.xlsx", sheet = "Metadata")
...
dapi_data <- read_excel("~/Desktop/GitHub/EEMB 144L/144l_students_2021/Input_Data/week4/144L_2021_BactAbund.xlsx", sheet = "DAPI_Data")
glimpse(dapi_data)
```
...
``` r
toc_data <- read_excel("~/Desktop/GitHub/EEMB 144L/144l_students_2021/Input_Data/week4/144L_2021_BactAbund.xlsx", sheet = "TOC_Data")
glimpse(toc_data)
```
...
#save your data to a .csv 
    write.csv(bactcarbon, "~/Desktop/GitHub/EEMB 144L//144l_students_2021/Output_Data:week6/211101_dapi_data_calculations.csv")
...
``` r
saveRDS(trt_ba, "~/Desktop/GitHub/EEMB 144L/144l_students_2021/Output_Data:week6/144L_Exp_Processed_BactAbund.rds")
```
...
``` r
saveRDS(trt_ba_biovol, "~/Desktop/GitHub/EEMB 144L/144l_students_2021/Output_Data:week6/144L_trt_ba_plot.rds")
```
...
``` r
saveRDS(bactcarbon, "~/Desktop/GitHub/EEMB 144L/144l_students_2021/Output_Data:week6/144L_Exp_Processed_BactAbund.rds")
```
